...
logging.basicConfig(filename=BASE_ADDR+"v5_2.log", filemode='w', format='%(name)s - %(levelname)s - %(message)s')
...
bep20=BEP20('https://bsc.mytokenpocket.vip')
erc20=ERC20("https://cloudflare-eth.com")
