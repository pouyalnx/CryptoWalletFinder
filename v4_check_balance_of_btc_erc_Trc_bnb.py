...
for _ in range(32):
    ...
    try:
        ...
        print(erc20.get_balance(account.address))
        print(trc20.get_balance(words))
        print(btc.get_balance(words))
        print(heco.get_balance(account.address))
    except:
        print("connection or address error")
    print("----------------------------------------------------------------")
